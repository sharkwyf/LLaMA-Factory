...
# model_name_or_path=output/dpo/mistral_7b-adversarial-raw-sigmoid-adversarial-raw-sigmoid-adversarial-raw-sigmoid-adversarial-raw-sigmoid
dataset_name=adversarial-raw
# dataset_name=adversarial-3-defender
pref_loss=sigmoid
pref_beta=0.01
